...
hi hello these are whalefacts generated by OpenAI's GPT-2 345M model! 

this finetuned model powers the [@whalefakes Twitter account](https://twitter.com/@whalefakes)

I wrote a blog post about this process [on Reading Supply](https://reading.supply/@mathemakitten/generating-whalefacts-with-gpt-2-x7gXxR).

**Changes**
* code has been added which cleans tweets copied from Twitter
* training tweets added 

Adapted from the original finetuning repository by @nshepperd.
